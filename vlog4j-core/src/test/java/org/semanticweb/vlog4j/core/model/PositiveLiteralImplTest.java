...
import org.semanticweb.vlog4j.core.model.implementation.NegativeLiteralImpl;
...
public class PositiveLiteralImplTest {
	...
	public void termSizeMatchesPredicateArity() {
		...
		Expressions.makePositiveLiteral(predicateArity1, Expressions.makeAbstractConstant("c"), Expressions.makeUniversalVariable("X"));
	}
