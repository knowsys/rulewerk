...
public class GeneratedAnonymousIndividualsTest {
	...
	private static final String includeBlanksFilePath = FileDataSourceUtils.OUTPUT_FOLDER + "include_blanks.csv";
	private static final String excludeBlanksFilePath = FileDataSourceUtils.OUTPUT_FOLDER + "exclude_blanks.csv";
	...
	public void testBlanksRestrictedChaseSplitHeadPieces()
		...
		try (final Reasoner reasoner = Reasoner.getInstance()) {
			...
			final List<List<String>> csvContentIncludeBlanks = FileDataSourceUtils.getCSVContent(includeBlanksFilePath);
			...
			final List<List<String>> csvContentExcludeBlanks = FileDataSourceUtils.getCSVContent(excludeBlanksFilePath);
