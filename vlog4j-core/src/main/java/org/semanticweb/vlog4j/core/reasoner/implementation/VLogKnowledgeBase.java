...
public class VLogKnowledgeBase {
	...
	int addDataSourceConfigurationString(final DataSource dataSource, final Predicate predicate,
		...
		if (dataSource != null) {
			if (dataSource instanceof VLogDataSource) {
				final VLogDataSource vLogDataSource = (VLogDataSource) dataSource;
				final String configString = vLogDataSource.toConfigString();
