...
import org.semanticweb.vlog4j.core.reasoner.RuleRewritingStrategy;
...
public class ModelToVLogConverter {
	...
	public static karmaresearch.vlog.VLog.RuleRewriteStrategy toVLogRuleRewriteStrategy(
			final RuleRewritingStrategy rewriteStrategy) {
		Validate.notNull(rewriteStrategy);
		...
		case SPLIT_HEAD_PIECES_AGGRESIVE:
			vLogRuleRewriteStrategy = RuleRewriteStrategy.AGGRESSIVE;
			break;
		case NONE:
		default:
			vLogRuleRewriteStrategy = RuleRewriteStrategy.NONE;
			break;
		}
