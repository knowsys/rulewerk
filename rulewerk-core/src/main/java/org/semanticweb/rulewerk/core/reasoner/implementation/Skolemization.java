...
/**
 * A class that implements skolemization of named null names. The same
 * name should be skolemized to the same {@link NamedNull} when
 * skolemized using the same instance, but to different instances of
 * {@link NamedNull} when skolemized using different instances of
 * {@link Skolemization}.
 *
...
public class Skolemization {
	...
	/**
	 * Skolemize a named null name. The same {@code name} will map to
